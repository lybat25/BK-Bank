    ...
    <script>
        window.onload = function() {
            ...
            if (savedUser     ) {
                ...
                showProfile(user.name, user.email); // Передаем email пользователя
            } else {
        ...
        function showProfile(name, email) {
            ...
            profileSection.innerHTML = 
                ...
                <p><strong>Email: <a href="mailto:${email}" style="color: #FFD700;">${email}</a></strong></p> <!-- Отображаем email пользователя -->
...
<div class="container">
    ...
    <div class="contact-info">
        ...
        <div class="yellow-line"></div> <!-- Желтая полоска под заголовком -->
        <p><strong>Email: <a href="mailto:hgaraew@mail.ru" style="color: #FFD700;">${email}</a></strong></p> <!-- Изменено на "БК-Банк email" с ссылкой -->
